...
let favoriteFoods = ['pizza', 'burrito', 'fish', 'bacon'];
...
console.log('The number of foods that I like;', favoriteFoods.length);
...
console.log('The food are now', favoriteFoods);
...
console.log(`Added a food to the begining: ${favoriteFoods}`);
